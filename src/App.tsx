...
export default function App() {
  const [activeTab, setActiveTab] = useState<'daily' | 'targets' | 'insights' | 'templates'>('daily');
  ...
  return (
    <div className="min-h-screen flex flex-col max-w-4xl mx-auto px-4 py-8 relative">
      ...
      <header className="flex justify-between items-center mb-12 relative z-10">
        ...
        <nav className="flex gap-2 bg-white/5 backdrop-blur-md p-1 rounded-full border border-white/10">
